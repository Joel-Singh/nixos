...
alias gd="git diff"
alias gp="git push"
alias cr='nix-shell /home/apple/repos/nixos/devshells/rust/shell.nix --run "cargo run --features bevy/dynamic_linking"'
alias cb='nix-shell /home/apple/repos/nixos/devshells/rust/shell.nix --run "cargo build --features bevy/dynamic_linking"'
alias cf="cargo fmt"
